          ...
          <div class="row">
               <div class="card work-experience">
                    <div class="card-body">
                         ...
                         <?php
                         $db = mysqli_connect("localhost:8889", "root", "123", "temp") or die("could not connect to server");
                         $query = mysqli_query($db, "SELECT * from tagslist where uid = $id;");
               ...
               <div class="container sidenav">
                    <form id="myForm" method="post" action="">
                         <div id="color-selector">
                              <button id="cadetblue" class="spn1" onclick="toggle(this)" name="cadetblue" value="cadetblue"></button>
                              <button id="blue" class="spn1" onclick="toggle(this)" name="blue" value="blue"></button>
                              <button id="green" class="spn1" onclick="toggle(this)" name="green" value="green"></button>
                              <button id="gray" class="spn1" onclick="toggle(this)" name="gray" value="gray"></button>
                              <button id="brown" class="spn1" onclick="toggle(this)" name="brown" value="brown"></button>
                         </div>
                    </form>
                    ...
                    <form enctype="multipart/form-data" id="frmBox" method="post" role="form" action="insert.php">
                         ...
                         <fieldset class="form-group">
                              ...
                              <table class="form-control" id="dynamic_field">
                                   <tr>
                                        <td><input type="text" name="name[]" placeholder="Add Skills" class="form-control name_list" /></td>
